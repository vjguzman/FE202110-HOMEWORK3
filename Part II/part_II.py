...
from quad4 import quad4, quad4_post, nodal_stress_averaging,quad4_line_load
...
def quad4_partII(file_name, properties, properties_load):
...
for i in file_name:
	quad4_partII(i,properties,properties_load)

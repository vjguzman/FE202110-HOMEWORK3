...
def quad9_orthotropic(xy, properties):
...
def quad9_nodal_stress_averaging(xy, properties, sigma):
	E = properties["E"]
	ν = properties["nu"]
	bx = properties["bx"]
	by = properties["by"]
	...
	for xi, eta, wi, wj in gauss_rule:
		...
		if xi == -sqrt(3/5) and eta == -sqrt(3/5):
			N[:,0] = [N0,N1,N2,N3,N4,N5,N6,N7,N8]
		
		if xi == sqrt(3/5) and eta == -sqrt(3/5):
			N[:,1] = [N0,N1,N2,N3,N4,N5,N6,N7,N8]
		
		if xi == sqrt(3/5) and eta == sqrt(3/5):
			N[:,2] = [N0,N1,N2,N3,N4,N5,N6,N7,N8]
		
		if xi == -sqrt(3/5) and eta == sqrt(3/5):
			N[:,3] = [N0,N1,N2,N3,N4,N5,N6,N7,N8]
		
		if xi == 0 and eta == -sqrt(3/5):
			N[:,4] = [N0,N1,N2,N3,N4,N5,N6,N7,N8]
		
		if xi == sqrt(3/5) and eta == 0:
			N[:,5] = [N0,N1,N2,N3,N4,N5,N6,N7,N8]
		
		if xi == 0 and eta == sqrt(3/5):
			N[:,6] = [N0,N1,N2,N3,N4,N5,N6,N7,N8]
		
		if xi == -sqrt(3/5) and eta == 0:
			N[:,7] = [N0,N1,N2,N3,N4,N5,N6,N7,N8]
		
		if xi == 0 and eta == 0:
			N[:,8] = [N0,N1,N2,N3,N4,N5,N6,N7,N8]
